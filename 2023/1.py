...
numbers_spelled = "one two three four five six seven eight nine".split()

# input = '''hree1foursgvfdrrqmk4two6
# onengzkkjsxsjlxxxthpd7xfcvkthreefour
# sixnine5sixeighthlvmf
# 63gkmbsdc3fourmgrjhrlbqgcfxf
# 2bmldthree7skhhpxfonenineone
...
# input = "2bmldthree7skhhpxfonenineone"
...
for line in lines:
    ...
    print()
    print(line)
    for value, n in enumerate(numbers_spelled):
        for nn in range(len(line)):
            index = line[nn:].find(n)
            if index >= 0:
                print("!!!!!!!")
                print(n)
                print(index)
                if index+nn > highest_i:
                    highest_i = index+nn
                    highest_number = value + 1
                if index+nn < lowest_i:
                    lowest_i = index+nn
                    lowest_number = value + 1
    ...
    # print(lowest_i)
    # print(highest_i)
    print(f"{lowest_number} + {highest_number}")
    number = str(lowest_number) + str(highest_number)
    res += int(number)
